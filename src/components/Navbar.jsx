...
function Navbar() {
  return (
    <nav style={{padding: '10px 0', backgroundColor: 'white', borderBottom: '1px solid #f1f1f1', position: 'sticky', top: 0, zIndex: 1000, height: '90px', display: 'flex', alignItems: 'center'}}>
      <div className="container" style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%'}}>
        {/* Brand - Left */}
        <div style={{flex: '1'}} onClick={() => window.location.hash = ''}>
        ...
        <div style={{flex: '1', display: 'flex', justifyContent: 'flex-end'}}>
           <a href="#all-packages" className="btn btn-primary" style={{padding: '12px 28px', fontSize: '0.85rem', fontWeight: 'bold'}}>Book Now</a>
        </div>
      </div>
    </nav>
  );
