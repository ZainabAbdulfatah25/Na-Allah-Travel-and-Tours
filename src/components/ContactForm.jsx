...
const styles = {
  section: { backgroundColor: '#f8fafc', padding: 'clamp(60px, 10vw, 100px) 0' },
  container: { maxWidth: '1100px' },
  contentGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '40px', alignItems: 'center' },
  infoSide: { textAlign: 'left' },
  heading: { fontSize: 'clamp(2.1rem, 6vw, 3.5rem)', color: 'var(--primary-navy)', marginBottom: '25px', lineHeight: '1.2', fontWeight: '900' },
  description: { fontSize: 'clamp(1rem, 2vw, 1.2rem)', color: '#64748b', marginBottom: '40px' },
  formSide: { backgroundColor: 'rgba(255,255,255,0.8)', backdropFilter: 'blur(10px)', padding: 'clamp(20px, 5vw, 45px)', borderRadius: '40px', boxShadow: '0 30px 60px -12px rgba(0,0,0,0.1)', border: '1px solid rgba(255,255,255,0.4)' },
  inputGroup: { marginBottom: '20px', flex: 1, minWidth: '220px' },
  ...
  input: { width: '100%', padding: '16px', borderRadius: '15px', border: '1px solid #e1e1e1', fontSize: '1rem', outline: 'none', boxSizing: 'border-box' },
