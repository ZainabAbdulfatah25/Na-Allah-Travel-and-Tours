...
function Packages() {
  ...
  useEffect(() => {
    ...
    if (match) {
      setSelectedDest(decodeURIComponent(match[1]));
    }
  }, []);
        ...
        {items.map((pkg, idx) => (
          <div key={idx} style={styles.card} className="package-card">
            ...
            <div style={styles.cardBody}>
              ...
              <a 
                href={`#payment?pkg=${encodeURIComponent(pkg.title + ' Package (Full)')}`} 
      ...
      <div className="container">
        ...
        <div style={{textAlign: 'center', marginBottom: '80px'}}>
          ...
          <p style={{fontSize: '1.2rem', color: 'var(--text-muted)', maxWidth: '800px', margin: '0 auto'}}>
            We provide world-class travel arrangements for Hajj and Umrah pilgrims.
          </p>
        </div>
        ...
        <div style={styles.specialNote}>
          <p style={{fontSize: '1.2rem'}}>
            <strong>Visa Notice:</strong> Separate visa processing is available starting from <strong>₦1,200,000</strong>. 
          </p>
          <a href="https://wa.me/message/4X32W3CFCBBNF1" className="btn btn-primary" style={{marginTop: '25px', padding: '15px 40px'}}>
            Talk to an Agent for Custom Deals
          </a>
        </div>
      </div>
    </section>
